...
const Login = () => {
    ...
    return (
      <div className='w-full flex flex-col my-32 items-center justify-center'>
        <form action={login} className='max-w-xs md:max-w-md lg:max-w-lg xl:max-w-xl flex flex-col justify-center items-center border-4 p-4 md:p-10 border-primary rounded'>
          ...
          <p className='mt-4'>Don't have an account? <a href="/register" className='font-bold text-black hover:text-white hover:rounded hover:bg-primary p-2'>Register</a></p>
        </form>
      </div>
    )
