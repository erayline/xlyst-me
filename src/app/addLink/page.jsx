...
const Register = () => {
  ...
  return (
    <div className='w-full flex flex-col my-32 lg:my-16 items-center justify-center'>
      <form action={addLink} className='max-w-xs md:max-w-md lg:max-w-lg xl:max-w-xl flex flex-col justify-center items-center border-4 p-4 md:p-10 border-primary rounded'>
        ...
        <div className="w-56 justify-center flex flex-row flex-wrap h-56 lg:h-48 py-2 mb-4 overflow-x-hidden bg-black rounded-xl overflow-scroll">
          {chosenIcon}
        </div>
