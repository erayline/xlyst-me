...
const Footer = () => {
  return (
    <div className='w-11/12 mt-10 h-32 border-t-2 border-zinc-700  flex flex-row justify-around'>
        <div>
            <h3 className='text-gray-200 underline text-center'>More</h3>
            <ul className='text-gray-400 gap-4 my-4 text-center flex flex-col'>
                <li><a href="https://eggable-mobile.vercel.app/">Eggable</a></li>
            </ul>
        </div>
        <div>
            <h3 className='text-gray-200 underline  text-center'>Me</h3>
            <ul className='text-gray-400 gap-4 my-4 text-center flex flex-col'>
