...
const Navbar = async () => {
  const session = await auth();
    ...
    <nav className="m-4 flex justify-center">
      <div className="rounded-xl mx-4 px-14 mt-5 lg:mt-0 lg:px-5 lg:w-2/3 h-24 text-white flex flex-wrap items-center justify-center lg:justify-between p-4 bg-slate-950">
