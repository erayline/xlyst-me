...
const SecondSection = () => {
  ...
  return (
    <div className='flex flex-col items-center p-4 my-20 border-y-2 border-zinc-800'>
      <div className='mt-0 lg:my-10  page-width max-w-screen-lg section-h justify-between items-center flex flex-col gap-10 lg:flex-row'>
